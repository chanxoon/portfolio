...
const web = parallel(fonts, images, scss, csscopy, scripts, jscopy, htmlssi);
const build = series(clean, parallel(fonts, images, scss, csscopy, scripts, jscopy, htmlssiBuild));
